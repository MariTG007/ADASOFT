...
namespace ADASOFT.Data
{
    public class SeedDb
    {
        ...
        //        await AddCourseAsync("Pintura", "Pintura Expresionista", 270000M, "Lunes-Miércoles", "", 0, new List<string>() { "elgrito.png" });
        ...
        //}
        //private async Task AddCourseAsync(string name, string description, decimal price, string date, string resume, int Quota, List<string> images)
        //{
        //    Course course = new()
        //    {
